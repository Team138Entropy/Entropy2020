...
public class GoalTrack {
     ...
     */
    public static synchronized GoalTrack makeNewTrack(int id, double timestamp, Pose2d IntialGoalObservation){
     ...
     * 
     * Will return true if the track is succesfully updated!
     */
    ...
    /**
     * Smooths positions
     * Takes average of all tracked positions 
     */
