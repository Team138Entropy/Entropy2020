...
public class GoalTracker {
    ...
    /**
     * TrackerReportComparators are used in the case that multiple tracks are active
     * (Multiple Tracks == Multiple Goals)
     * Calculate a score for each track (highest score wins)
     * Algorithm is pretty simple.. reward stability, recency 
     */
