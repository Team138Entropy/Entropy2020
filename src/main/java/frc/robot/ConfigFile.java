...
public class ConfigFile {
    ...
    /**
     * Reloads the configuration file. Run it after changing the file's contents. It will run when
     * the constructor is initalized (no need to manually run it the first time).
     */
    public void reload() {
        // load the config
        ...
        try (InputStream input =
                new FileInputStream(
                        Filesystem.getDeployDirectory() + "/defaultconfig.properties")) {
