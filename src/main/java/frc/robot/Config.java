...
public class Config {
  ...
  public enum Key {
    ...
    CLIMBER_EXTEND_SPEED(1d),
    CLIMBER_RETRACT_SPEED(-1d),
    ...
    CLIMBER_OVERCURRENT_THRESHOLD(12d),
    CLIMBER_OVERCURRENT_MIN_OCCURENCES(25),
    CLIMBER_OVERCURRENT_COUNTDOWN_LENGTH(30d),
